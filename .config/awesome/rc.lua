...
beautiful.menu_bg_normal = "#374247aa"
beautiful.menu_fg_focus = "#374247"
beautiful.menu_bg_focus = "#f7f4e0aa"
...
globalkeys = gears.table.join(
  ...
  awful.key(
    ...
    { description = "focus on down client", group = "client"}
  ),
  ...
  awful.key(
    ...
    { description = "focus on up client", group = "client" }
  ),
  ...
  awful.key({ modkey, "Shift"   }, "e", function () awful.spawn("bash /home/sebastian/.config/rofi/powermenu/powermenu.sh") end,
  ...
  awful.key({ modkey,           }, "Down",     function () awful.client.incwfact( -0.05)          end,
            {description = "decrease master hight factor", group = "layout"}),
  awful.key({ modkey,           }, "Up",     function () awful.client.incwfact(0.05)          end,
            {description = "increase master hight factor", group = "layout"}),
  ...
  awful.key({modkey}, 'space', function() awful.util.spawn("bash /home/sebastian/.config/rofi/launchers/launcher.sh") end,
  {description='run rofi', group='launcher'}),

  awful.key({ modkey }, 'b', function() awful.util.spawn("qbpm choose") end,
  {description='Open Browser', group='launcher'}),

  -- awful.key({modkey, "Shift" }, 'c', function() awful.util.spawn("qbpm choose Chat") end,
  -- {description='Open Ferdium', group='launcher'}),
...
awful.spawn.with_shell("xrandr --output eDP --off --output HDMI-A-0 --mode 2560x1080 --pos 0x0 --rotate normal")
awful.spawn.with_shell("xrandr --noprimary")
...
-- border_settintgs
local border_focus = "#008b94"
local border_normal = "#282828AA"
